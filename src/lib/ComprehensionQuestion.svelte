...
<script lang="ts">
  ...
  const log = debug("app:ComprehensionQuestion");
  ...
  <span class="cq-input-wrapper">
      ...
      <span class="cq-icon-overlay correct">
        <!-- ✅ -->
         <svg width="100%" height="100%" viewBox="0 0 100 100">
          <g>
            <circle r="35" cx="50" cy="50" fill="forestgreen" stroke="black" stroke-width="5"/>
            <path
    ...
    {#if     answerLabelClasses[answer.cid] &&
      ...
      <span class="cq-icon-overlay incorrect">
        ...
        <svg width="100%" height="100%" viewBox="0 0 100 100">
          <g>
            <circle r="35" cx="50" cy="50" fill="red" stroke="black" stroke-width="5"/>
